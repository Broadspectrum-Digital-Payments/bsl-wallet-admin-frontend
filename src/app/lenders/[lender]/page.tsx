...
export default function MerchantDetailsPage() {
    ...
    return (
        <div className="xl:pl-72 bg-slate-900">
            <div
            ...
            <main>
                ...
                <div className="divide-y divide-white/5">
                    <div
                        ...
                        <div>
                            <h2 className="text-base font-semibold leading-7 text-white">Personal
                                Information</h2>
                    ...
                    <div
                        className="grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-4 py-16 sm:px-6 md:grid-cols-3 lg:px-8">
                        <div>
                            <h2 className="text-base font-semibold leading-7 text-white">Log out other
                                sessions</h2>
                            <p className="mt-1 text-sm leading-6 text-gray-400">
