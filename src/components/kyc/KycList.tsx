...
const KycList: React.FC = () => {
    ...
    const users = [
        {externalId: 'bhjsdhvsg', name: 'Lindsay Walton', phone: '0244554456', status: 'queued', ghanaCardNumber: '123456789'},
        {externalId: 'ajhvskdaj', name: 'Joana Mensah', phone: '0244538475', status: 'queued', ghanaCardNumber: '123456789'},
    ]
