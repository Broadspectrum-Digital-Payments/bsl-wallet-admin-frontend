...
const LoanShow: React.FC = () => {
    ...
    const loanId = useParams()?.loan.toString();
    ...
    const handleApproveKyc = () => {
        ...
        updateUser(loan.externalId, approvedData)
            .then(async response => {
    ...
    const handleRejectKyc = () => {
        ...
        updateUser(loan.externalId, declinedData)
            .then(async response => {
                            ...
                            <div className="bg-white">
                                <div className="">
                                    ...
                                    >
                                        ...
                                        {/*{loan && loan.files.length > 0 ? loan.files.map((document) => (*/}
