            ...
            <div className="space-y-6 pb-10">
                <div>
                    ...
                    <dl className="mt-2 divide-y divide-gray-200 border-b border-t border-gray-200">
                        ...
                        <ListItem title="Amount" description={formatAmount(loan.amount)}/>
                        <ListItem title="Duration" description={formatAmount(loan.amount, '')}/>
                        <ListItem title="Interest Rate" description={`${loan.amount}%`}/>
                        <ListItem title="Total Repayment Amount" description={formatAmount(loan.amount)}/>
                        <ListItem title="Total Repayment Paid" description={formatAmount(loan.amount)}/>
                        <ListItem title="Repayment Balance" description={formatAmount(loan.amount)}/>
